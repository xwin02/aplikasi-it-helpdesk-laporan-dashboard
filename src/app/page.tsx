...
import { BarChart3, FileText, Ticket, TrendingUp, Clock, Shield, BookOpen, ArrowRight, Sparkles, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50 dark:from-emerald-950 dark:via-teal-950 dark:to-green-950">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-20">
            <Card className="hover:shadow-2xl transition-all duration-300 hover:scale-105 border-emerald-200 dark:border-emerald-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardTitle className="text-emerald-900 dark:text-emerald-100">Manajemen Tiket</CardTitle>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="text-center group">
                <div className="bg-gradient-to-br from-cyan-100 to-cyan-200 dark:from-cyan-900 dark:to-cyan-800 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform">
                  <BarChart3 className="h-10 w-10 text-cyan-600 dark:text-cyan-300" />
                </div>
          ...
          {/* Stats Section */}
          <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-emerald-200 dark:border-emerald-800 mb-20">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                <div className="flex items-center justify-center gap-2 mb-2">
                  <CheckCircle2 className="h-6 w-6 text-emerald-600" />
                  <div className="text-4xl font-bold text-emerald-700">Fast</div>
                </div>
              ...
              <div>
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <div className="text-4xl font-bold text-teal-700">24/7</div>
                </div>
              ...
              <div>
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <div className="text-4xl font-bold text-green-700">Efficient</div>
                </div>
                <p className="text-gray-600 dark:text-gray-400">Ticket Management</p>
              </div>
            </div>
          </div>
